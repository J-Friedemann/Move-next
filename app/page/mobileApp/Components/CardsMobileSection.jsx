...
const CardsMobileSection = () => {
  return (
    <section className="grid grid-flow-row lg:grid-cols-2 xl:grid-cols-3 mt-24 sm:mt-52 mx-auto justify-items-center lg:justify-around gap-12">
      <Features.Root>
        <Features.Image path="/Page/MobileApp/SVG/icon-3-music.svg" />
      ...
      <Features.Root>
        <Features.Image path="/Page/MobileApp/SVG/icon-2-music.svg" />
      ...
      <Features.Root>
        <Features.Image path="/Page/MobileApp/SVG/icon-music.svg" />
