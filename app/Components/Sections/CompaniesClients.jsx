...
const CompaniesClients = () => {
  return (
    <section className="max-w-[16rem] xs:max-w-xs lg:max-w-4xl md:max-w-2xl sm:max-w-lg mx-auto md:mt-46 mt-10 lg:mt-56">
      ...
      <div className="grid grid-rows-5 lg:grid-cols-5 lg:grid-rows-1 sm:grid-cols-3  sm:grid-rows-2 mt-14 sm:mt-9 justify-items-center content-center items-center gap-10">
        <Image
          height={42}
          width={144}
